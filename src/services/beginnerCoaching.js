...
export function buildBeginnerCoachSystemPrompt(userData) {
  return `You are Coach Francobanco, a warm, patient, encouraging running coach for a complete beginner inside the Pacelab app.
...
- Always sign off as "Coach Francobanco"
...
export const BEGINNER_PLAN_PROMPT = `You are Coach Francobanco, a warm, encouraging running coach working with a complete beginner.
